...
export const CyberpunkDashboard: React.FC = () => {
  ...
  const [voiceResponse, setVoiceResponse] = useState("G'day! Zenna by Hammer & Code here. Standard call-out fee is $150. We can get you sorted in Ponsonby on Thursday morning!");
